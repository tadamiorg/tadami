...
import com.sf.animescraper.network.requests.utils.WebViewClientCompat
import com.sf.animescraper.network.requests.utils.isOutdated
...
class CloudflareInterceptor(private val context: Context) : WebViewInterceptor(context) {
    ...
    private val networkHelper: HttpClient by injectLazy()
    ...
    override fun intercept(chain: Interceptor.Chain, request: Request, response: Response): Response {
        ...
        // we don't crash the entire app
            ...
            throw IOException("Can't bypass cloudflare")
        } catch (e: Exception) {
            throw IOException(e)
        }
    }
    ...
    private fun resolveWithWebView(originalRequest: Request, oldCookie: Cookie?) {
        ...
        if (!cloudflareBypassed) {
            ...
            if (isWebViewOutdated) {
                ...
                UiToasts.showToast("Webview outdated")
            }
